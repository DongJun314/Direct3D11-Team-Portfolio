...
int32 Client::CInventorySystem::Tick(float _fDeltaSeconds)
{
	...
	// test 특정 이벤트 발생(아이템과 충돌, 아이템 get)
	{
		...
		{			
			AddItemToContainer(EItemType::GRASSMAMMOTH_MEAT, 1);
			AddItemToContainer(EItemType::COMMON_SHIELD, 1);
			AddItemToContainer(EItemType::BOAR_MEAT, 100);
			AddItemToContainer(EItemType::WOOD, 100);
			AddItemToContainer(EItemType::WOOL, 100);
			AddItemToContainer(EItemType::STONE, 100);
			AddItemToContainer(EItemType::PALDIUM_FRAGMENT, 100);
			AddItemToContainer(EItemType::LEATHER, 50);
			AddItemToContainer(EItemType::CLOTH, 50);
			AddItemToContainer(EItemType::GUNPOWDER, 50);
			AddItemToContainer(EItemType::CARBON, 50);
			AddItemToContainer(EItemType::RIFLE_BULLET, 50);
			AddItemToContainer(EItemType::IRON_INGOT, 100);
			AddItemToContainer(EItemType::COAL, 100);
			AddItemToContainer(EItemType::OLD_BOW, 1);
			AddItemToContainer(EItemType::STONE_AXE, 1);
			AddItemToContainer(EItemType::ARROW, 10);
